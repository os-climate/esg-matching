...
def clean_unicode(str_value):
    ...
    if not isinstance(str_value, str):
        raise AttributeError('Unicode cleaning cannot be applied to non string values.')
...
def apply_cleaning_rules(str_value, dict_cleaning_rules):
    ...
    """
    if not isinstance(str_value, str):
        raise AttributeError('Cleaning rules cannot be applied to non string values.')
